...
const Retell_Lecture = ({ hours = 0, minutes = 0, seconds = 0 }) => {
...
const restart=(e)=>{
  e.preventDefault();
  setPaused(false)
  setTime([parseInt(hours), parseInt(1), parseInt(40)]);
  myRef.current.play();
    ...
    <div>
      ...
      <div className="container border border-dark  ">
        ...
        // <button id="auto" onClick={startAudio}>start</button>
          ...
          <Link to="/RetellLecture2" className=" btn btn-success float-end mx-5 my-5  ">Next</Link>
