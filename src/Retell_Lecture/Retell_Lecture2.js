...
const Retell_Lecture2 = ({ hours = 0, minutes = 0, seconds = 0 }) => {
  ...
  const [[h, m, s], setTime] = React.useState([hours=0, minutes=1 ,seconds=40]);
...
const reset = () => {
  setTime([parseInt(hours), parseInt(0), parseInt(40)]);
    setOver(false);
    stop()
...
const restart=(e)=>{
  e.preventDefault();
  setPaused(false)
  setTime([parseInt(hours), parseInt(minutes), parseInt(80)]);
  myRef.current.play();
    ...
    <div>
      ...
      <div className="container border border-dark  ">
        ...
        // <button id="auto" onClick={startAudio}>start</button>
          ...
          <button className="border rounded-pill btn btn-info d-none  "   onClick={skip}  >   
...
export default Retell_Lecture2;
