...
const Drag = () => {
    ...
    // const formData = new FormData(); formData.append('file', data);
    ...
    return (
        <div>
            ...
            <div className="container-fluid border border-dark  ">
               ...
               < div className = "text-center " > </div> < div className = "text-left" > <Link to="/Drag2" className=" btn btn-success float-end mx-5 my-5  ">Next</Link> <button className = " btn btn-primary mx-2 my-5" > Submit </button>
                </div > </div> </div>
    )
}
